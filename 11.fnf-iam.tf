...
#   function_name =  data.terraform_remote_state.lambda_state.outputs.fnf-lambda-authorizer.function_name // aws_lambda_function.fnf-lambda-authorizer.function_name
...
#   action        = "lambda:InvokeFunction"
#   function_name =  data.terraform_remote_state.lambda_state.outputs.fnf-lambda-pre-token-authorizer.function_name // aws_lambda_function.fnf-lambda-pre-token-authorizer.function_name
#   principal     = "apigateway.amazonaws.com"
# }
...
#   action        = "lambda:InvokeFunction"
#   function_name = data.terraform_remote_state.lambda_state.outputs.fnf-lambda-create-user.function_name // aws_lambda_function.fnf-lambda-create-user.function_name
#   principal     = "apigateway.amazonaws.com"
# }
...
#   action        = "lambda:InvokeFunction"
#   function_name = data.terraform_remote_state.lambda_state.outputs.fnf-lambda-pre-signup.function_name // aws_lambda_function.fnf-lambda-pre-signup.function_name
#   principal     = "apigateway.amazonaws.com"
# }
